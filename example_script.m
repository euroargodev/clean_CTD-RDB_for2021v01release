...
boxlist=[5600        5601        5602        5603        5604];%[3600        3601        3602        5600        5601        5602        5603        5604 ...
...
inpath=outpath;
outpath=[outp 'A4\'];
% in this step near duplicates are those that are less than 1 day appart
% (this could be converted to a function input in the future so the user
% can change that - line 49 in box_meta_neardup) and that have the same position if one truncates the
% longitude and latitude to 1 digit - lines 29 and 30 in box_meta_neardup)
