...
clear CONF DES* dlabel* excl NEAR tmp EXCL f i ind indpairs IND j PERC* SKI output output_label pairs2
...
clear CONF DES* dlabel* excl NEAR tmp EXCL f i ind indpairs IND j PERC* SKI output output_label pairs2 boxlist out
